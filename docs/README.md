...
| 5 | [`v2/v2-desk-research.md`](./v2/v2-desk-research.md) | V2 deep-dive research: Form E practitioners, AI extraction, pension complexity, real user struggles |
| 6 | [`v2/v2-research-implications.md`](./v2/v2-research-implications.md) | How V2 research changes the design and prioritisation |

### 2. Design direction (20 min)

| # | Document | What you'll learn |
|---|----------|-------------------|
| 7 | [`v1/v1-visual-design.md`](./v1/v1-visual-design.md) | Design thesis ("warm hand on a cold day"), palette, typography |
| 8 | [`v2/v2-concept.md`](./v2/v2-concept.md) | The Guided Picture Builder — three layers, priority flow, user scenarios |
| 9 | [`v2/workspace-visual-redesign.md`](./v2/workspace-visual-redesign.md) | Bold 2026 direction — layout, colour zones, typography hierarchy |
| 10 | [`v2/v2-decisions.md`](./v2/v2-decisions.md) | Architecture and UX decisions made during V2 build |
...
|---|----------|-------------------|
| 11 | [`workspace-spec/01-design-system.md`](./workspace-spec/01-design-system.md) | Typography scale, spacing, colour usage rules |
| 12 | [`workspace-spec/02-page-map.md`](./workspace-spec/02-page-map.md) | Workspace URL hierarchy |
| 13 | [`workspace-spec/03-sidebar-navigation.md`](./workspace-spec/03-sidebar-navigation.md) | Sidebar structure, width, status indicators |
| 14 | [`workspace-spec/04-workspace-home.md`](./workspace-spec/04-workspace-home.md) | Mission control page |
| 15 | ~~[`workspace-spec/05-build-your-picture.md`](./workspace-spec/05-build-your-picture.md)~~ | **[SUPERSEDED]** Original layout |
| 16 | **[`workspace-spec/05b-build-your-picture-revised.md`](./workspace-spec/05b-build-your-picture-revised.md)** | **Current build spec**: one page, three zones, two-tier tabs |
| 17 | [`workspace-spec/06-category-detail.md`](./workspace-spec/06-category-detail.md) | Per-category deep-dive layout |
| 18 | [`workspace-spec/07-future-phases.md`](./workspace-spec/07-future-phases.md) | Placeholder pages for V3–V5 |
| 19 | [`workspace-spec/08-interaction-patterns.md`](./workspace-spec/08-interaction-patterns.md) | When to use modals, navigation, inline expansion |
| 20 | **[`workspace-spec/09-upload-review-flow.md`](./workspace-spec/09-upload-review-flow.md)** | **Key unbuilt spec**: upload zone, review panel, side-by-side PDF, celebration |
| 21 | **[`workspace-spec/10-ai-analysis-flow.md`](./workspace-spec/10-ai-analysis-flow.md)** | **Core to V2**: domain reasoning, staggered reveal |
| 22 | **[`workspace-spec/10b-ai-tiered-questions.md`](./workspace-spec/10b-ai-tiered-questions.md)** | **Implemented**: four confidence tiers, step-through dialogue |
| 23 | **[`workspace-spec/11-ai-question-mapping.md`](./workspace-spec/11-ai-question-mapping.md)** | **Not yet implemented**: 8-domain signal→question mapping |
| 24 | [`workspace-spec/12-two-tier-tabs.md`](./workspace-spec/12-two-tier-tabs.md) | Page tabs + category tabs architecture |
