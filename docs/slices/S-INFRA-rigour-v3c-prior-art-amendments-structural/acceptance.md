...
- **Verification:**
  ...
  3. Test PR (synthetic; can be the next session's wrap PR) touching a protected path WITHOUT review attached: GitHub UI shows "Code owner review required" + merge button disabled.
