...
export const registry: RegistryRow[] = [
  ...
  row({ id: 'pre-signup-interview', title: 'Pre-signup interview O1-O8', section: 'pre-auth-public', status: 'spec-only', confidence: 'low', tags: ['ai-dependent', 'free-tier', 'blocks-launch', 'high-uncertainty'], openQuestions: ['How does AI plan (spec 74) inject between question and answer reveal?', 'Stepper: 8 dots vs progress bar vs "Question N of 8"?', 'Back navigation: edit prior answers, or one-way flow?'], links: { spec: 'docs/workspace-spec/65-pre-signup-interview-reconciled.md', prototype: 'src/app/start/' } }),
