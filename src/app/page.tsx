    ...
    <>
      ...
      <main className="flex-1">
        ...
        <section className="mx-auto max-w-2xl px-6 py-28 text-center sm:py-36">
          ...
          <p className="mx-auto mt-8 max-w-lg text-lg leading-relaxed text-ink-light">
        ...
        <section className="border-t border-cream-dark bg-cream-dark/50 py-20">
          <div className="mx-auto max-w-3xl px-6">
            ...
            <p className="mx-auto mt-4 max-w-lg text-center text-sm leading-relaxed text-ink-light">
            ...
            <div className="mt-14 space-y-12 sm:space-y-0 sm:grid sm:grid-cols-2 sm:gap-8 lg:grid-cols-4">
              ...
              <div className="text-center">
                ...
                <p className="mt-1 text-xs font-medium text-warmth-dark">Free</p>
        ...
        <section className="py-20">
          <div className="mx-auto max-w-3xl px-6">
            ...
            <div className="mt-12 space-y-6">
              <div className="rounded-[var(--radius-md)] border border-cream-dark p-6">
        ...
        {/* Final CTA */}
        <section className="border-t border-cream-dark py-20">
          <div className="mx-auto max-w-2xl px-6 text-center">
            <h2 className="font-heading text-2xl font-bold text-ink">
              Start with a free plan. Upgrade when it makes sense.
            </h2>
            <p className="mx-auto mt-4 max-w-md text-sm leading-relaxed text-ink-light">
