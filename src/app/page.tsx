          ...
          <div className="mx-auto max-w-3xl px-6">
            ...
            <div className="mt-16 grid gap-12 sm:grid-cols-3">
              <div className="text-center">
                ...
                <h3 className="mt-5 font-heading text-lg font-semibold text-ink">Tell us your situation</h3>
              ...
              <div className="text-center">
                ...
                <h3 className="mt-5 font-heading text-lg font-semibold text-ink">See your route</h3>
                <p className="mt-3 text-sm leading-relaxed text-ink-light">
              ...
              <div className="text-center">
                ...
                <h3 className="mt-5 font-heading text-lg font-semibold text-ink">Get your plan</h3>
                <p className="mt-3 text-sm leading-relaxed text-ink-light">
